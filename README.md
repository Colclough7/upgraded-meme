...
2. cd into the assessment folder.

3. Then, install dependencies locally by running the command:
...
5. To watch how the code you write affects the application website, you can run the following command. This command will start a server and take over your terminal window. To stop the server from running, you can press Control+C.
